...
export const agentAdvices: AgentAdvice[] = [
  {
    ...
    avatar:
      "https://api.dicebear.com/7.x/big-ears-neutral/svg?seed=Felix&backgroundColor=b6e3f4",
    tagColor: "text-[#2D8C69]",
    tagBg: "bg-[#E8F3EF]",
    time: "1분 전",
  },
  {
    ...
    avatar:
      "https://api.dicebear.com/7.x/big-ears-neutral/svg?seed=Garrett&backgroundColor=ffdfbf",
  ...
  },
  {
    ...
    avatar:
      "https://api.dicebear.com/7.x/big-ears-neutral/svg?seed=Jasper&backgroundColor=d1d5db",
...
export const newsListMock: NewsItem[] = [
  {
    ...
    time: "2시간 전",
    content:
      "소헌컴퍼니가 최근 발표한 분기 실적에서 사업 부문의 수익성이 크게 개선되면서 어닝 서프라이즈를 기록했습니다.",
  },
  {
    id: 2,
    category: "시장 이슈",
    ...
    time: "5시간 전",
    content:
      "글로벌 거시 경제 환경의 불확실성에도 불구하고 외국인 투자자들의 매수세가 반도체 대형주로 집중되고 있습니다.",
  },
  {
    id: 3,
    category: "공시 정보",
    ...
    time: "7시간 전",
    content:
      "신규 설비 투자를 통해 차세대 반도체 생산 능력을 확충할 계획입니다.",
  },
  {
    id: 4,
    category: "증권가 전망",
    ...
    time: "12시간 전",
    content:
      "주요 증권사들이 잇따라 목표 주가를 올리며 향후 주가 흐름을 낙관하고 있습니다.",
  },
  {
    id: 5,
    category: "테크 트렌드",
    ...
    time: "어제",
    content:
      "AI 시장의 급성장에 대응하기 위한 기업의 전략적 행보가 주목받고 있습니다.",
  },
];
...
export const generalNewsList: GeneralNewsItem[] = [
  ...
  },
  {
    ...
    category: "ETF · 자금 흐름",
    title: "기관 자금 순유입 전환",
    summary: "연기금 중심 매수세 유입 확인",
    source: "Market Insight",
  },
  {
    id: 4,
    category: "글로벌 증시",
    title: "미국 증시 연속 상승 마감",
    summary: "기술주 중심 위험자산 선호 지속",
    source: "Wall Street Brief",
  },
  {
    id: 5,
    category: "국내 이슈",
    title: "한국은행 발언 이후 시장 반응",
    summary: "금리 동결 기조 유지 시그널",
    source: "Seoul Economy",
  },
  {
    id: 6,
    category: "금리 변동",
    title: "연준 의장 추가 금리 인하 시사",
    summary: "글로벌 시장 안도감 확대",
